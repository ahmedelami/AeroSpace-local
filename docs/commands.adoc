...
== move-node-to-monitor-local-workspace
----
include::aerospace-move-node-to-monitor-local-workspace.adoc[tags=synopsis]
----
include::aerospace-move-node-to-monitor-local-workspace.adoc[tags=purpose]
include::aerospace-move-node-to-monitor-local-workspace.adoc[tags=body]
...
== move-node-to-local-workspace
----
include::aerospace-move-node-to-local-workspace.adoc[tags=synopsis]
----
include::aerospace-move-node-to-local-workspace.adoc[tags=purpose]
include::aerospace-move-node-to-local-workspace.adoc[tags=body]
...
== swap-local-workspaces
----
include::aerospace-swap-local-workspaces.adoc[tags=synopsis]
----
include::aerospace-swap-local-workspaces.adoc[tags=purpose]
include::aerospace-swap-local-workspaces.adoc[tags=body]
...
== workspace-local
----
include::aerospace-workspace-local.adoc[tags=synopsis]
----
include::aerospace-workspace-local.adoc[tags=purpose]
include::aerospace-workspace-local.adoc[tags=body]
