...
let subcommandDescriptions = [
    ...
    ["  move-node-to-local-workspace", "Move the focused window to a monitor-local workspace slot"],
    ["  move-node-to-monitor-local-workspace", "Move the focused window to a slot on another monitor"],
    ...
    ["  swap-local-workspaces", "Swap the active workspaces between two monitors"],
    ...
    ["  workspace-local", "Focus the workspace slot local to the currently focused monitor"],
